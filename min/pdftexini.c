...
initialize ( void ) 
{
  ...
  pagesofar [7 ]= 0 ;
  pagemaxdepth = 0 ;
  {register integer for_end; k = 29277 ;for_end = 30183 ; if ( k <= for_end) 
  do 
    xeqlevel [k ]= 1 ;
  while ( k++ < for_end ) ;} 
  ...
  if ( iniversion ) 
  {
    ...
    while ( k++ < for_end ) ;} 
    {register integer for_end; k = 29277 ;for_end = 29637 ; if ( k <= 
    for_end) do 
      eqtb [k ].cint = 0 ;
    while ( k++ < for_end ) ;} 
    eqtb [29332 ].cint = 256 ;
    ...
    while ( k++ < for_end ) ;} 
    eqtb [29684 ].cint = 0 ;
    {register integer for_end; k = 29894 ;for_end = 30183 ; if ( k <= 
    for_end) do 
      eqtb [k ].cint = 0 ;
    while ( k++ < for_end ) ;} 
    primused = 2100 ;
    ...
    eqtb [15525 ].hh.b1 = 1 ;
    hash [15525 ].v.RH = 577 ;
    eqtb [29915 ].cint = ( onehundredinch + 50 ) / 100 ;
    ...
    eqtb [29343 ].cint = 72 ;
    eqtb [29348 ].cint = 4 ;
    eqtb [29352 ].cint = 1000 ;
    eqtb [29353 ].cint = 2200 ;
    eqtb [29354 ].cint = 1 ;
    eqtb [29355 ].cint = 0 ;
    eqtb [29927 ].cint = onebp ;
    eqtb [29364 ].cint = 0 ;
    eqtb [29926 ].cint = -65536000L ;
    eqtb [29924 ].cint = eqtb [29926 ].cint ;
    eqtb [29925 ].cint = eqtb [29926 ].cint ;
    eqtb [29922 ].cint = eqtb [29926 ].cint ;
    eqtb [29923 ].cint = eqtb [29926 ].cint ;
...
znewtrieop ( smallnumber d , smallnumber n , trieopcode v ) 
{
  ...
  while ( true ) {
    ...
    if ( l == 0 ) 
    {
      ...
      overflow ( 1363 , trieopsize ) ;
      u = trieused [curlang ];
      if ( u == maxtrieop ) 
      overflow ( 1364 , maxtrieop - mintrieop ) ;
      incr ( trieopptr ) ;
      incr ( u ) ;
      trieused [curlang ]= u ;
      if ( u > maxopused ) 
...
zlinebreak ( boolean d ) 
{
  ...
  if ( eqtb [27158 ].hh .v.RH == -2147483647L ) {
    ...
    if ( eqtb [29911 ].cint == 0 ) 
    {
      ...
      {
	firstwidth = eqtb [29897 ].cint - abs ( eqtb [29911 ].cint ) ;
	if ( eqtb [29911 ].cint >= 0 ) 
	firstindent = eqtb [29911 ].cint ;
	else firstindent = 0 ;
	secondwidth = eqtb [29897 ].cint ;
	secondindent = 0 ;
      } 
	...
	firstwidth = eqtb [29897 ].cint ;
	firstindent = 0 ;
	secondwidth = eqtb [29897 ].cint - abs ( eqtb [29911 ].cint ) ;
	if ( eqtb [29911 ].cint >= 0 ) 
	secondindent = eqtb [29911 ].cint ;
	else secondindent = 0 ;
      } 
    } 
  } 
  ...
  while ( true ) {
	...
	if ( mem [curp ].hh.b1 == 1 ) 
	{
	  ...
	  activewidth [1 ]= activewidth [1 ]+ mem [curp + 1 ].cint ;
	  if ( ( eqtb [29356 ].cint > 1 ) && ( mem [curp ].hh.b1 == 0 ) ) 
	  {
      ...
      case 7 : 
	{
	  ...
	  trybreak ( eqtb [29281 ].cint , 1 ) ;
	      ...
	      case 11 : 
		{
		  ...
		  if ( ( mem [s ].hh.b0 == 11 ) && ( eqtb [29356 ].cint > 
		  1 ) && ( mem [s ].hh.b1 == 0 ) ) 
		  {
	  ...
	  while ( r > 0 ) {
		...
		if ( ( mem [s ].hh.b0 == 11 ) && ( eqtb [29356 ].cint > 1 
		) && ( mem [s ].hh.b1 == 0 ) ) 
		{
	...
	;
      ...
      printnl ( 1349 ) ;
#endif /* STAT */
      background [2 ]= background [2 ]+ eqtb [29914 ].cint ;
      finalpass = true ;
    } 
  } 
  lablinebreak30: 
...
prefixedcommand ( void ) 
{
  ...
  case 95 : 
	...
	default: 
	{
	  ...
	  {case 2 : 
	    if ( ( a >= 4 ) ) 
	    geqdefine ( p , 73 , 29382 + curval ) ;
	    else eqdefine ( p , 73 , 29382 + curval ) ;
	    break ;
	  case 3 : 
	    if ( ( a >= 4 ) ) 
	    geqdefine ( p , 74 , 29928 + curval ) ;
	    else eqdefine ( p , 74 , 29928 + curval ) ;
	    break ;
	  case 4 : 
	    if ( ( a >= 4 ) ) 
...
storefmtfile ( void ) 
{
  ...
  packjobname ( 939 ) ;
  while ( ! wopenout ( fmtfile ) ) promptfilename ( 1719 , 939 ) ;
  printnl ( 1720 ) ;
  ...
  if ( hashhigh > 0 ) 
  dumpthings ( eqtb [30184 ], hashhigh ) ;
  dumpint ( parloc ) ;
  dumpint ( writeloc ) ;
  ...
  if ( hashhigh > 0 ) 
  dumpthings ( hash [30184 ], hashhigh ) ;
  dumpint ( cscount ) ;
  println () ;
  printint ( cscount ) ;
  print ( 1703 ) ;
...
loadfmtfile ( void ) 
{
  ...
  if ( hashhigh > 0 ) 
  undumpthings ( eqtb [30184 ], hashhigh ) ;
  {
    undumpint ( x ) ;
    if ( ( x < 514 ) || ( x > hashtop ) ) 
    goto labloadfmtfile6666 ;
  ...
  if ( hashhigh > 0 ) 
  {
    undumpthings ( hash [30184 ], hashhigh ) ;
    if ( debugformatfile ) 
    {
      printcsnames ( 30184 , hashhigh - ( 30184 ) ) ;
    } 
  } 
  undumpint ( cscount ) ;
  {
  ...
  ;
  {
    undumpimagemeta ( eqtb [29348 ].cint , eqtb [29351 ].cint ) ;
...
initprim ( void ) 
{
  ...
  primitive ( 440 , 73 , 29277 ) ;
  primitive ( 441 , 73 , 29278 ) ;
  primitive ( 442 , 73 , 29279 ) ;
  primitive ( 443 , 73 , 29280 ) ;
  primitive ( 444 , 73 , 29281 ) ;
  primitive ( 445 , 73 , 29282 ) ;
  primitive ( 446 , 73 , 29283 ) ;
  primitive ( 447 , 73 , 29284 ) ;
  primitive ( 448 , 73 , 29285 ) ;
  primitive ( 449 , 73 , 29286 ) ;
  primitive ( 450 , 73 , 29287 ) ;
  primitive ( 451 , 73 , 29288 ) ;
  primitive ( 452 , 73 , 29289 ) ;
  primitive ( 453 , 73 , 29290 ) ;
  primitive ( 454 , 73 , 29291 ) ;
  primitive ( 455 , 73 , 29292 ) ;
  primitive ( 456 , 73 , 29293 ) ;
  primitive ( 457 , 73 , 29294 ) ;
  primitive ( 458 , 73 , 29295 ) ;
  primitive ( 459 , 73 , 29296 ) ;
  primitive ( 460 , 73 , 29297 ) ;
  primitive ( 461 , 73 , 29298 ) ;
  primitive ( 462 , 73 , 29299 ) ;
  primitive ( 463 , 73 , 29300 ) ;
  primitive ( 464 , 73 , 29301 ) ;
  primitive ( 465 , 73 , 29302 ) ;
  primitive ( 466 , 73 , 29303 ) ;
  primitive ( 467 , 73 , 29304 ) ;
  primitive ( 468 , 73 , 29305 ) ;
  primitive ( 469 , 73 , 29306 ) ;
  primitive ( 470 , 73 , 29307 ) ;
  primitive ( 471 , 73 , 29308 ) ;
  primitive ( 472 , 73 , 29309 ) ;
  primitive ( 473 , 73 , 29310 ) ;
  primitive ( 474 , 73 , 29311 ) ;
  primitive ( 475 , 73 , 29312 ) ;
  primitive ( 476 , 73 , 29313 ) ;
  primitive ( 477 , 73 , 29314 ) ;
  primitive ( 478 , 73 , 29315 ) ;
  primitive ( 479 , 73 , 29316 ) ;
  primitive ( 480 , 73 , 29317 ) ;
  primitive ( 481 , 73 , 29318 ) ;
  primitive ( 482 , 73 , 29319 ) ;
  primitive ( 483 , 73 , 29320 ) ;
  primitive ( 484 , 73 , 29321 ) ;
  primitive ( 485 , 73 , 29322 ) ;
  primitive ( 486 , 73 , 29323 ) ;
  primitive ( 487 , 73 , 29324 ) ;
  primitive ( 488 , 73 , 29325 ) ;
  primitive ( 489 , 73 , 29326 ) ;
  primitive ( 490 , 73 , 29327 ) ;
  primitive ( 491 , 73 , 29328 ) ;
  primitive ( 492 , 73 , 29329 ) ;
  primitive ( 493 , 73 , 29330 ) ;
  primitive ( 494 , 73 , 29331 ) ;
  if ( mltexp ) 
  {
    mltexenabledp = true ;
    if ( false ) 
    primitive ( 495 , 73 , 29332 ) ;
    primitive ( 496 , 73 , 29333 ) ;
    primitive ( 497 , 73 , 29334 ) ;
  } 
  if ( enctexp ) 
  {
    enctexenabledp = true ;
    primitive ( 498 , 73 , 29335 ) ;
    primitive ( 499 , 73 , 29336 ) ;
    primitive ( 500 , 73 , 29337 ) ;
    primitive ( 501 , 73 , 29338 ) ;
  } 
  primitive ( 502 , 73 , 29339 ) ;
  primitive ( 503 , 73 , 29340 ) ;
  primitive ( 504 , 73 , 29359 ) ;
  primitive ( 505 , 73 , 29341 ) ;
  primitive ( 506 , 73 , 29342 ) ;
  primitive ( 507 , 73 , 29343 ) ;
  primitive ( 508 , 73 , 29344 ) ;
  primitive ( 509 , 73 , 29345 ) ;
  primitive ( 536 , 73 , 29348 ) ;
  primitive ( 510 , 73 , 29346 ) ;
  primitive ( 511 , 73 , 29347 ) ;
  primitive ( 512 , 73 , 29348 ) ;
  primitive ( 513 , 73 , 29349 ) ;
  primitive ( 514 , 73 , 29350 ) ;
  primitive ( 515 , 73 , 29351 ) ;
  primitive ( 516 , 73 , 29352 ) ;
  primitive ( 517 , 73 , 29353 ) ;
  primitive ( 518 , 73 , 29354 ) ;
  primitive ( 519 , 73 , 29355 ) ;
  primitive ( 520 , 73 , 29356 ) ;
  primitive ( 521 , 73 , 29357 ) ;
  primitive ( 522 , 73 , 29358 ) ;
  primitive ( 523 , 73 , 29360 ) ;
  primitive ( 524 , 73 , 29361 ) ;
  primitive ( 525 , 73 , 29362 ) ;
  primitive ( 526 , 73 , 29363 ) ;
  primitive ( 527 , 73 , 29364 ) ;
  primitive ( 528 , 73 , 29365 ) ;
  primitive ( 529 , 73 , 29366 ) ;
  primitive ( 530 , 73 , 29367 ) ;
  primitive ( 531 , 73 , 29368 ) ;
  primitive ( 532 , 73 , 29369 ) ;
  primitive ( 533 , 73 , 29370 ) ;
  primitive ( 534 , 73 , 29371 ) ;
  primitive ( 539 , 74 , 29894 ) ;
  primitive ( 540 , 74 , 29895 ) ;
  ...
  primitive ( 721 , 112 , 3 ) ;
  primitive ( 722 , 112 , 4 ) ;
  primitive ( 537 , 89 , membot + 0 ) ;
  primitive ( 574 , 89 , membot + 1 ) ;
  primitive ( 412 , 89 , membot + 2 ) ;
  primitive ( 413 , 89 , membot + 3 ) ;
  primitive ( 755 , 79 , 104 ) ;
  primitive ( 756 , 79 , 1 ) ;
  primitive ( 757 , 82 , 0 ) ;
  primitive ( 758 , 82 , 1 ) ;
  primitive ( 759 , 83 , 1 ) ;
  ...
  primitive ( 846 , 110 , 8 ) ;
  primitive ( 847 , 110 , 9 ) ;
  primitive ( 848 , 110 , 10 ) ;
  primitive ( 849 , 110 , 11 ) ;
  primitive ( 850 , 110 , 12 ) ;
  primitive ( 851 , 110 , 16 ) ;
  primitive ( 852 , 110 , 17 ) ;
  primitive ( 853 , 110 , 13 ) ;
  primitive ( 854 , 110 , 14 ) ;
  primitive ( 855 , 110 , 15 ) ;
  primitive ( 856 , 110 , 20 ) ;
  primitive ( 857 , 110 , 21 ) ;
  primitive ( 858 , 110 , 22 ) ;
  primitive ( 859 , 110 , 23 ) ;
  primitive ( 860 , 110 , 24 ) ;
  primitive ( 861 , 110 , 25 ) ;
  primitive ( 862 , 110 , 26 ) ;
  primitive ( 863 , 110 , 27 ) ;
  primitive ( 864 , 110 , 28 ) ;
  primitive ( 865 , 110 , 18 ) ;
  primitive ( 866 , 110 , 19 ) ;
  primitive ( 867 , 110 , 29 ) ;
  primitive ( 868 , 110 , 30 ) ;
  primitive ( 869 , 110 , 33 ) ;
  primitive ( 870 , 110 , 31 ) ;
  primitive ( 871 , 110 , 32 ) ;
  primitive ( 910 , 107 , 0 ) ;
  primitive ( 911 , 107 , 1 ) ;
  primitive ( 912 , 107 , 2 ) ;
  primitive ( 913 , 107 , 3 ) ;
  ...
  primitive ( 918 , 107 , 8 ) ;
  primitive ( 919 , 107 , 9 ) ;
  primitive ( 920 , 107 , 10 ) ;
  primitive ( 921 , 107 , 11 ) ;
  primitive ( 922 , 107 , 12 ) ;
  primitive ( 923 , 107 , 13 ) ;
  primitive ( 924 , 107 , 14 ) ;
  primitive ( 925 , 107 , 15 ) ;
  primitive ( 926 , 107 , 16 ) ;
  primitive ( 927 , 107 , 21 ) ;
  primitive ( 929 , 108 , 2 ) ;
  hash [15518 ].v.RH = 929 ;
  ...
  primitive ( 1308 , 4 , 256 ) ;
  primitive ( 1309 , 5 , 257 ) ;
  hash [15515 ].v.RH = 1309 ;
  eqtb [15515 ]= eqtb [curval ];
  primitive ( 1310 , 5 , 258 ) ;
  hash [15519 ].v.RH = 1311 ;
  hash [15520 ].v.RH = 1311 ;
  eqtb [15520 ].hh.b0 = 9 ;
  ...
  primitive ( 1473 , 20 , 4 ) ;
  primitive ( 1383 , 20 , 5 ) ;
  primitive ( 1474 , 20 , 108 ) ;
  primitive ( 1475 , 31 , 99 ) ;
  primitive ( 1476 , 31 , 100 ) ;
  primitive ( 1477 , 31 , 101 ) ;
  primitive ( 1478 , 31 , 102 ) ;
  primitive ( 1494 , 43 , 1 ) ;
  primitive ( 1495 , 43 , 0 ) ;
  primitive ( 1496 , 43 , 2 ) ;
  primitive ( 1506 , 25 , 12 ) ;
  primitive ( 1507 , 25 , 11 ) ;
  primitive ( 1508 , 25 , 10 ) ;
  primitive ( 1509 , 23 , 0 ) ;
  primitive ( 1510 , 23 , 1 ) ;
  primitive ( 1511 , 24 , 0 ) ;
  primitive ( 1512 , 24 , 1 ) ;
  ...
  primitive ( 1544 , 48 , 0 ) ;
  primitive ( 1545 , 48 , 1 ) ;
  primitive ( 1275 , 50 , 16 ) ;
  primitive ( 1276 , 50 , 17 ) ;
  primitive ( 1277 , 50 , 18 ) ;
  primitive ( 1278 , 50 , 19 ) ;
  primitive ( 1279 , 50 , 20 ) ;
  primitive ( 1280 , 50 , 21 ) ;
  primitive ( 1281 , 50 , 22 ) ;
  primitive ( 1282 , 50 , 23 ) ;
  primitive ( 1284 , 50 , 26 ) ;
  primitive ( 1283 , 50 , 27 ) ;
  primitive ( 1546 , 51 , 0 ) ;
  primitive ( 1288 , 51 , 1 ) ;
  primitive ( 1289 , 51 , 2 ) ;
  primitive ( 1270 , 53 , 0 ) ;
  ...
  primitive ( 1568 , 52 , 4 ) ;
  primitive ( 1569 , 52 , 5 ) ;
  primitive ( 1285 , 49 , 30 ) ;
  primitive ( 1286 , 49 , 31 ) ;
  hash [15517 ].v.RH = 1286 ;
  ...
  if ( enctexp ) 
  {
    primitive ( 1614 , 94 , 10 ) ;
    primitive ( 1615 , 94 , 11 ) ;
  } 
  primitive ( 1621 , 95 , 0 ) ;
  primitive ( 1622 , 95 , 1 ) ;
  primitive ( 1623 , 95 , 2 ) ;
  ...
  primitive ( 435 , 85 , 27741 ) ;
  if ( enctexp ) 
  {
    primitive ( 1633 , 85 , 27690 ) ;
    primitive ( 1634 , 85 , 27691 ) ;
    primitive ( 1635 , 85 , 27692 ) ;
  } 
  primitive ( 439 , 85 , 28765 ) ;
  primitive ( 436 , 85 , 27997 ) ;
  primitive ( 437 , 85 , 28253 ) ;
  primitive ( 438 , 85 , 28509 ) ;
  primitive ( 538 , 85 , 29638 ) ;
  primitive ( 432 , 86 , 27693 ) ;
  primitive ( 433 , 86 , 27709 ) ;
  primitive ( 434 , 86 , 27725 ) ;
  primitive ( 1355 , 99 , 0 ) ;
  primitive ( 1367 , 99 , 1 ) ;
  primitive ( 1651 , 78 , 0 ) ;
  primitive ( 1652 , 78 , 1 ) ;
  ...
  primitive ( 1658 , 78 , 8 ) ;
  primitive ( 1659 , 78 , 9 ) ;
  primitive ( 1660 , 78 , 10 ) ;
  primitive ( 1661 , 78 , 11 ) ;
  primitive ( 1662 , 78 , 6 ) ;
  primitive ( 274 , 100 , 0 ) ;
  primitive ( 275 , 100 , 1 ) ;
  primitive ( 276 , 100 , 2 ) ;
  primitive ( 1670 , 100 , 3 ) ;
  primitive ( 1671 , 60 , 1 ) ;
  primitive ( 1672 , 60 , 0 ) ;
  primitive ( 1673 , 58 , 0 ) ;
  primitive ( 1674 , 58 , 1 ) ;
  primitive ( 1680 , 57 , 27997 ) ;
  primitive ( 1681 , 57 , 28253 ) ;
  primitive ( 1682 , 19 , 0 ) ;
  primitive ( 1683 , 19 , 1 ) ;
  primitive ( 1684 , 19 , 2 ) ;
  primitive ( 1685 , 19 , 3 ) ;
  ...
  primitive ( 1733 , 59 , 2 ) ;
  primitive ( 1734 , 59 , 3 ) ;
  hash [15524 ].v.RH = 1734 ;
  eqtb [15524 ]= eqtb [curval ];
  primitive ( 1735 , 59 , 4 ) ;
  primitive ( 1736 , 59 , 5 ) ;
  primitive ( 1737 , 59 , 6 ) ;
  primitive ( 1136 , 59 , 38 ) ;
  primitive ( 1738 , 59 , 39 ) ;
  primitive ( 1739 , 59 , 40 ) ;
  primitive ( 1740 , 59 , 41 ) ;
  primitive ( 1741 , 59 , 7 ) ;
  primitive ( 1742 , 59 , 8 ) ;
  primitive ( 1743 , 59 , 9 ) ;
  primitive ( 1744 , 59 , 10 ) ;
  primitive ( 1745 , 59 , 11 ) ;
  primitive ( 1746 , 59 , 12 ) ;
  primitive ( 1747 , 59 , 13 ) ;
  primitive ( 1748 , 59 , 14 ) ;
  primitive ( 1749 , 59 , 15 ) ;
  primitive ( 1750 , 59 , 16 ) ;
  primitive ( 1751 , 59 , 17 ) ;
  primitive ( 1752 , 59 , 18 ) ;
  primitive ( 1753 , 59 , 19 ) ;
  primitive ( 1754 , 59 , 20 ) ;
  primitive ( 1755 , 59 , 21 ) ;
  primitive ( 1756 , 59 , 34 ) ;
  primitive ( 1757 , 59 , 35 ) ;
  primitive ( 1758 , 59 , 36 ) ;
  primitive ( 1759 , 59 , 22 ) ;
  primitive ( 1760 , 59 , 23 ) ;
  primitive ( 1761 , 59 , 24 ) ;
  primitive ( 1762 , 59 , 26 ) ;
  primitive ( 1763 , 59 , 25 ) ;
  primitive ( 1764 , 59 , 27 ) ;
  primitive ( 1765 , 59 , 28 ) ;
  primitive ( 1766 , 59 , 29 ) ;
  primitive ( 1767 , 59 , 30 ) ;
  primitive ( 1768 , 59 , 31 ) ;
  primitive ( 1769 , 59 , 33 ) ;
  primitive ( 1770 , 59 , 32 ) ;
  primitive ( 1771 , 59 , 37 ) ;
  primitive ( 1772 , 59 , 42 ) ;
  primitive ( 1773 , 59 , 43 ) ;
  primitive ( 1774 , 59 , 44 ) ;
  primitive ( 1775 , 59 , 45 ) ;
  nonewcontrolsequence = true ;
} 
#endif /* INITEX */
void 
mainbody ( void ) 
{
  ...
  outputfilename = 0 ;
  {
    ...
    == 1698 ) ) 
    {
      nonewcontrolsequence = false ;
      primitive ( 1968 , 70 , 3 ) ;
      primitive ( 1969 , 70 , 20 ) ;
      primitive ( 872 , 110 , 5 ) ;
      primitive ( 1971 , 72 , 27172 ) ;
      primitive ( 1972 , 73 , 29372 ) ;
      primitive ( 1973 , 73 , 29373 ) ;
      primitive ( 1974 , 73 , 29374 ) ;
      primitive ( 1975 , 73 , 29375 ) ;
      primitive ( 1976 , 73 , 29376 ) ;
      primitive ( 1977 , 73 , 29377 ) ;
      primitive ( 1978 , 73 , 29378 ) ;
      primitive ( 1979 , 73 , 29379 ) ;
      primitive ( 1980 , 73 , 29380 ) ;
      primitive ( 1995 , 70 , 21 ) ;
      primitive ( 1996 , 70 , 22 ) ;
      primitive ( 1997 , 70 , 23 ) ;
      primitive ( 1998 , 70 , 24 ) ;
      primitive ( 1999 , 70 , 25 ) ;
      primitive ( 2000 , 70 , 28 ) ;
      primitive ( 2001 , 70 , 29 ) ;
      primitive ( 2002 , 70 , 30 ) ;
      primitive ( 2003 , 70 , 31 ) ;
      primitive ( 2004 , 70 , 32 ) ;
      primitive ( 2005 , 70 , 33 ) ;
      primitive ( 2006 , 70 , 34 ) ;
      primitive ( 2007 , 19 , 4 ) ;
      primitive ( 2009 , 19 , 5 ) ;
      primitive ( 2010 , 111 , 1 ) ;
      primitive ( 2011 , 111 , 5 ) ;
      primitive ( 2012 , 19 , 6 ) ;
      primitive ( 2016 , 82 , 2 ) ;
      primitive ( 1287 , 49 , 1 ) ;
      primitive ( 2020 , 73 , 29381 ) ;
      primitive ( 2021 , 33 , 6 ) ;
      primitive ( 2022 , 33 , 7 ) ;
      primitive ( 2023 , 33 , 10 ) ;
      primitive ( 2024 , 33 , 11 ) ;
      primitive ( 2033 , 106 , 2 ) ;
      primitive ( 2035 , 96 , 1 ) ;
      primitive ( 928 , 104 , 1 ) ;
      primitive ( 2036 , 107 , 17 ) ;
      primitive ( 2037 , 107 , 18 ) ;
      primitive ( 2038 , 107 , 19 ) ;
      primitive ( 2039 , 107 , 20 ) ;
      primitive ( 2040 , 107 , 22 ) ;
      primitive ( 2041 , 107 , 23 ) ;
      primitive ( 1603 , 93 , 8 ) ;
      primitive ( 2047 , 70 , 39 ) ;
      primitive ( 2048 , 70 , 40 ) ;
      primitive ( 2049 , 70 , 41 ) ;
      primitive ( 2050 , 70 , 42 ) ;
      primitive ( 2054 , 70 , 26 ) ;
      primitive ( 2055 , 70 , 27 ) ;
      primitive ( 2056 , 70 , 35 ) ;
      primitive ( 2057 , 70 , 36 ) ;
      primitive ( 2058 , 70 , 37 ) ;
      primitive ( 2059 , 70 , 38 ) ;
      primitive ( 2060 , 18 , 5 ) ;
      primitive ( 2061 , 112 , 5 ) ;
      primitive ( 2062 , 112 , 6 ) ;
      primitive ( 2063 , 112 , 7 ) ;
      primitive ( 2064 , 112 , 8 ) ;
      primitive ( 2065 , 112 , 9 ) ;
      primitive ( 2069 , 24 , 2 ) ;
      primitive ( 2070 , 24 , 3 ) ;
      primitive ( 2071 , 84 , 27429 ) ;
      primitive ( 2072 , 84 , 27430 ) ;
      primitive ( 2073 , 84 , 27431 ) ;
      primitive ( 2074 , 84 , 27432 ) ;
    ...
    eqtb [29364 ].cint = pdfdraftmodevalue ;
    ...
    magicoffset = strstart [1302 ]- 9 * 16 ;
    if ( interaction == 0 ) 
    selector = 16 ;
    else selector = 17 ;
