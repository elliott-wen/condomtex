...
getnext ( void ) 
{
  ...
  if ( curinput .statefield != 0 ) 
  {
    labgetnext25: if ( curinput .locfield <= curinput .limitfield ) 
    {
      ...
      incr ( curinput .locfield ) ;
      labgetnext21: curcmd = eqtb [27738 + curchr ].hh .v.RH ;
      ...
      case 33 : 
	{
	  ...
	  curcs = 513 ;
	    ...
	    labgetnext26: k = curinput .locfield ;
	    curchr = buffer [k ];
...
scanrulespec ( void ) 
{
  ...
  labscanrulespec21: if ( scankeyword ( 831 ) ) 
  {
    scandimen ( false , false , false ) ;
    mem [q + 1 ].cint = curval ;
...
zoutwhat ( halfword p ) 
{
  ...
  case 2 : 
	...
	else if ( j < 16 ) 
	{
	  ...
	  aopenout ( writefile [j ]) ) promptfilename ( 1906 , 939 ) ;
	  writeopen [j ]= true ;
	  if ( logopened ) 
	  {
	    oldsetting = selector ;
...
hlistout ( void ) 
{
  ...
  while ( p != -2147483647L ) labhlistout21: if ( ( p >= himemmin ) ) 
  {
	...
	enddiagnostic ( false ) ;
	goto labhlistout22 ;
	labhlistout40: if ( eqtb [29309 ].cint > 99 ) 
	{
	  begindiagnostic () ;
	  printnl ( 2061 ) ;
	  print ( c ) ;
...
zliteral ( strnumber s , integer literalmode , boolean warn ) 
{
  ...
  if ( literalmode == 3 ) 
  {
    if ( ! ( strinstr ( s , 1057 , 0 ) || strinstr ( s , 1058 , 0 ) ) ) 
    {
      if ( warn && ! ( strinstr ( s , 1059 , 0 ) || strinstr ( s , 1060 , 0 ) 
    ...
    if ( strinstr ( s , 1063 , ( strstart [1058 ]- strstart [1057 ]) ) ) 
    {
      j = j + ( strstart [1064 ]- strstart [1063 ]) ;
      literalmode = 2 ;
    } 
    else if ( strinstr ( s , 1064 , ( strstart [1058 ]- strstart [1057 ]) 
    ) ) 
    {
...
zadjustinterwordglue ( halfword p , halfword g ) 
{
  ...
  {
    pdfwarning ( 1078 , 1079 , false , false ) ;
    return ;
  } 
  c = 256 ;
  if ( ( p >= himemmin ) ) 
...
ztfmlookup ( strnumber s , scaled fs ) 
{
  ...
  if ( fs != 0 ) 
  {
    ...
    do 
      if ( ( fontarea [k ]!= 1077 ) && streqstr ( fontname [k ], s ) && ( 
      fontsize [k ]== fs ) ) 
      {
	flushstr ( s ) ;
	Result = k ;
...
readexpandfont ( void ) 
{
  ...
  if ( ( pdffontstep [f ]!= 0 ) ) 
  {
    ...
    pdfwarning ( 1031 , 1092 , true , true ) ;
...
zvfdeffont ( internalfontnumber f ) 
{
  ...
  if ( k != 0 ) 
  {
    ...
    vflocalfontwarning ( f , k , 1105 ) ;
    if ( ds != fontdsize [k ]) 
    vflocalfontwarning ( f , k , 1106 ) ;
  } 
  if ( ( pdffontstep [f ]!= 0 ) ) 
...
zdovf ( internalfontnumber f ) 
{
  ...
  return ;
  stacklevel = 0 ;
  packfilename ( fontname [f ], 345 , 1099 ) ;
  if ( ! vfbopenin ( vffile ) ) 
  return ;
  if ( vfbyte () != 247 ) 
...
zwarndestdup ( integer id , smallnumber byname , strnumber s1 , strnumber s2 ) 
{
  ...
  return ;
  pdfwarning ( s1 , 1828 , false , false ) ;
  if ( byname > 0 ) 
  {
    print ( 1814 ) ;
    printmark ( id ) ;
...
zdodest ( halfword p , halfword parentbox , scaled x , scaled y ) 
{
  ...
  {
    warndestdup ( mem [p + 5 ].hh .v.RH , mem [p + 5 ].hh.b1 , 1841 , 1842 
    ) ;
    return ;
  } 
  objtab [k ].int4 = p ;
...
pdfhlistout ( void ) 
{
  ...
  while ( p != -2147483647L ) labpdfhlistout21: if ( ( p >= himemmin ) ) 
  {
	...
	enddiagnostic ( false ) ;
	goto labpdfhlistout22 ;
	labpdfhlistout40: if ( eqtb [29309 ].cint > 99 ) 
	{
	  begindiagnostic () ;
	  printnl ( 2061 ) ;
	  print ( c ) ;
...
zpdfshipout ( halfword p , boolean shippingpage ) 
{
  ...
  if ( ! shippingpage ) 
  {
    ...
    pdfindirectln ( 1142 , pdflastresources ) ;
  } 
  pdfbeginstream () ;
  if ( shippingpage ) 
  {
  ...
  if ( shippingpage ) 
  {
    ...
    pdfindirectln ( 1161 , pdflastpages ) ;
...
zpdffixdest ( integer k ) 
{
  ...
  if ( objtab [k ].int4 != -2147483647L ) 
  return ;
  pdfwarning ( 1191 , 345 , false , false ) ;
  if ( objtab [k ].int0 < 0 ) 
  {
    print ( 1192 ) ;
...
pdfprintinfo ( void ) 
{
  ...
  if ( pdfinfotoks != -2147483647L ) 
  {
    ...
    creatorgiven = substrofstr ( 1213 , s ) ;
    producergiven = substrofstr ( 1214 , s ) ;
    creationdategiven = substrofstr ( 1215 , s ) ;
    moddategiven = substrofstr ( 1216 , s ) ;
    trappedgiven = substrofstr ( 1217 , s ) ;
  } 
  if ( ! producergiven ) 
  {
    pdfprint ( 1222 ) ;
  ...
  {
    pdfstrentryln ( 1221 , pdftexbanner ) ;
  } 
  pdfenddict () ;
} 
void 
...
zhpack ( halfword p , scaled w , smallnumber m ) 
{
  ...
  showbox ( r ) ;
  enddiagnostic ( true ) ;
  labhpack10: if ( ( eqtb [29374 ].cint > 0 ) ) 
  {
...
zpostlinebreak ( boolean d ) 
{
  ...
  do {
    ...
    labpostlinebreak30: if ( eqtb [29350 ].cint > 0 ) 
    {
...
initmath ( void ) 
{
  ...
  if ( ( curcmd == 3 ) && ( curlist .modefield > 0 ) ) 
  {
	...
	labinitmath45: p = mem [p ].hh .v.RH ;
      ...
      labinitmath30: if ( ( eqtb [29374 ].cint > 0 ) ) 
      {
...
zcheckpdfoutput ( strnumber s , boolean iserror ) 
{
  ...
  if ( eqtb [29332 ].cint <= 0 ) 
  {
    if ( iserror ) 
    pdferror ( s , 1762 ) ;
    else pdfwarning ( s , 1763 , true , true ) ;
  } 
} 
void 
scanpdfexttoks ( void ) 
...
zscaleimage ( integer n ) 
{
  ...
  if ( ( xr > 65535L ) || ( yr > 65535L ) ) 
  {
    xr = 0 ;
    yr = 0 ;
    pdfwarning ( 1761 , 1793 , true , true ) ;
  } 
...
scanpdfboxspec ( void ) 
{
  ...
  else if ( scankeyword ( 1797 ) ) 
  Result = pdfboxspecbleed ;
  else if ( scankeyword ( 1798 ) ) 
...
scanaltrule ( void ) 
{
  ...
  labscanaltrule21: if ( scankeyword ( 831 ) ) 
  {
    scandimen ( false , false , false ) ;
...
scanimage ( void ) 
{
  ...
  {
    pdfwarning ( 1802 , 1803 , true , true ) ;
  ...
  {
    pdfwarning ( 1802 , 1804 , true , true ) ;
  ...
  if ( eqtb [29342 ].cint > 0 ) 
  {
    if ( warnpdfpagebox ) 
    {
      pdfwarning ( 1802 , 1805 , true , true ) ;
      warnpdfpagebox = false ;
    } 
...
scanaction ( void ) 
{
  ...
  if ( scankeyword ( 1808 ) ) 
  mem [p ].hh.b0 = 3 ;
  else if ( scankeyword ( 1809 ) ) 
  mem [p ].hh.b0 = 1 ;
  else if ( scankeyword ( 1810 ) ) 
  mem [p ].hh.b0 = 2 ;
  else pdferror ( 1761 , 1811 ) ;
  if ( mem [p ].hh.b0 == 3 ) 
  {
    scanpdfexttoks () ;
...
zpdffixthread ( integer thread ) 
{
  pdffixthread_regmem 
  halfword a  ;
  pdfwarning ( 1810 , 1865 , false , false ) ;
  if ( objtab [thread ].int0 < 0 ) 
  {
    print ( 1192 ) ;
...
doextension ( void ) 
{
  ...
  case 3 : 
    {
      newwhatsit ( 3 , 2 ) ;
      mem [curlist .tailfield + 1 ].hh .v.LH = -2147483647L ;
      p = scantoks ( false , true ) ;
      mem [curlist .tailfield + 1 ].hh .v.RH = defref ;
    } 
    break ;
  ...
  case 17 : 
	...
	if ( scankeyword ( 1832 ) ) 
	{
      ...
      else if ( scankeyword ( 1838 ) ) 
      mem [curlist .tailfield + 5 ].hh.b0 = 7 ;
      else if ( scankeyword ( 1839 ) ) 
      mem [curlist .tailfield + 5 ].hh.b0 = 1 ;
      else pdferror ( 1761 , 1840 ) ;
      {
	getxtoken () ;
	if ( curcmd != 10 ) 
	backinput () ;
  ...
  case 38 : 
	...
	j = 3 ;
      ...
      else if ( scankeyword ( 1773 ) ) 
      {
	i = 1 ;
	j = 3 ;
      } 
      else if ( scankeyword ( 1774 ) ) 
      {
	i = 2 ;
	j = 2 ;
      } 
      else if ( scankeyword ( 1775 ) ) 
      {
	i = 3 ;
	j = 2 ;
      } 
  ...
  case 7 : 
	...
	if ( scankeyword ( 1784 ) ) 
	{
	  ...
	  if ( ( k <= 0 ) || ( k > objptr ) || ( objtab [k ].int4 != 0 ) ) 
	  {
	    pdfwarning ( 1782 , 1785 , true , true ) ;
	    pdfretval = -1 ;
	    k = -1 ;
	  } 
	} 
...
maincontrol ( void ) 
{
  ...
  labmaincontrol101: mains = eqtb [28506 + curchr ].hh .v.RH ;
  if ( mains == 1000 ) 
  curlist .auxfield .hh .v.LH = 1000 ;
  else if ( mains < 1000 ) 
  {
  ...
  if ( fixedpdfoutput > 0 ) 
  {
	...
	if ( fixedpdfdraftmode == 0 ) 
	{
	  ...
	  while ( objtab [k ].int4 == 0 ) {
	    ...
	    pdfwarning ( 1191 , 1196 , false , false ) ;
	    printint ( objtab [k ].int0 ) ;
	    print ( 1197 ) ;
	    println () ;
	    println () ;
	  ...
	  for_end) do 
		...
		pdfmarkchar ( i , j ) ;
	      ...
	      pdffontattr [i ], pdffontattr [k ]) ) 
	      {
		pdfwarning ( 1198 , 1199 , false , false ) ;
	  ...
	  do {
		...
		pdfprint ( 1202 ) ;
		{
	      ...
	      pdfintentryln ( 1186 , objtab [l ].int0 ) ;
	      if ( ! isroot ) 
	      pdfindirectln ( 1161 , pdflastpages ) ;
	      pdfprint ( 1203 ) ;
	      j = 0 ;
	  ...
	  if ( pdffirstoutline != 0 ) 
	  {
	    ...
	    pdfindirectln ( 1184 , pdffirstoutline ) ;
	    pdfindirectln ( 1185 , pdflastoutline ) ;
	    pdfintentryln ( 1186 , k ) ;
	    pdfenddict () ;
	    k = headtab [4 ];
	    while ( k != 0 ) {
		...
		pdflastoutline = k ;
	      ...
	      pdfbegindict ( k , 1 ) ;
	      pdfindirectln ( 1187 , pdfmem [objtab [k ].int4 ]) ;
	      pdfindirectln ( 65 , pdfmem [objtab [k ].int4 + 6 ]) ;
	      if ( pdfmem [objtab [k ].int4 + 1 ]!= 0 ) 
	      pdfindirectln ( 1161 , pdfmem [objtab [k ].int4 + 1 ]) ;
	      if ( pdfmem [objtab [k ].int4 + 2 ]!= 0 ) 
	      pdfindirectln ( 1188 , pdfmem [objtab [k ].int4 + 2 ]) ;
	      if ( pdfmem [objtab [k ].int4 + 3 ]!= 0 ) 
	      pdfindirectln ( 1189 , pdfmem [objtab [k ].int4 + 3 ]) ;
	      if ( pdfmem [objtab [k ].int4 + 4 ]!= 0 ) 
	      pdfindirectln ( 1184 , pdfmem [objtab [k ].int4 + 4 ]) ;
	      if ( pdfmem [objtab [k ].int4 + 5 ]!= 0 ) 
	      pdfindirectln ( 1185 , pdfmem [objtab [k ].int4 + 5 ]) ;
	      if ( objtab [k ].int0 != 0 ) 
	      pdfintentryln ( 1186 , objtab [k ].int0 ) ;
	  ...
	  pdfindirectln ( 1208 , pdflastpages ) ;
	  if ( threads != 0 ) 
	  pdfindirectln ( 1209 , threads ) ;
	  if ( outlines != 0 ) 
	  pdfindirectln ( 1210 , outlines ) ;
	  if ( namestree != 0 ) 
	  pdfindirectln ( 1211 , namestree ) ;
	  ...
	  if ( pdfcatalogopenaction != 0 ) 
	  pdfindirectln ( 1212 , pdfcatalogopenaction ) ;
	  pdfenddict () ;
	  pdfprintinfo () ;
	  if ( pdfosenable ) 
	  {
	    ...
	    pdfindirectln ( 1233 , root ) ;
	    pdfindirectln ( 1234 , objptr - 1 ) ;
	  ...
	  if ( ! pdfosenable ) 
	  {
	    ...
	    pdfprint ( 1236 ) ;
	    pdfintentryln ( 1230 , sysobjptr + 1 ) ;
	    pdfindirectln ( 1233 , root ) ;
	    pdfindirectln ( 1234 , sysobjptr ) ;
	    if ( pdftrailertoks != -2147483647L ) 
	    {
	      pdfprinttoksln ( pdftrailertoks ) ;
	      {
	...
	if ( fixedpdfdraftmode == 0 ) 
	bclose ( pdffile ) ;
	else pdfwarning ( 0 , 1190 , true , true ) ;
      } 
      if ( logopened ) 
      {
	putc ('\n',  logfile );
