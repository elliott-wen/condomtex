...
zgetnode ( integer s ) 
{
  ...
  overflow ( 304 , memmax + 1 - memmin ) ;
  lab40: mem [r ].hh .v.RH = -2147483647L ;
	;
#ifdef STAT
  varused = varused + s ;
#endif /* STAT */
  ...
  while ( p != -2147483647L ) {
	...
	r = getnode ( 3 ) ;
	{
	  ...
	  mem [r + 2 ].hh .v.LH = getavail () ;
	    ...
	    mem [mem [r + 2 ].hh .v.LH ].hh .v.ME = curchrsig ;
	;
#ifdef STAT
	    incr ( dynused ) ;
#endif /* STAT */
...
popnest ( void ) 
{
  popnest_regmem 
  {
    ...
    mem [curlist .headfield ].hh .v.ME = 0 ;
	;
#ifdef STAT
    decr ( dynused ) ;
#endif /* STAT */
...
zsaveforafter ( halfword t ) 
{
  ...
  if ( curlevel > 1 ) 
  {
    ...
    savestack [saveptr ].hh .v.ME = curchrsig ;
    incr ( saveptr ) ;
  } 
} 
void 
...
getnext ( void ) 
{
  ...
  else if ( curinput .locfield != -2147483647L ) 
  {
    ...
    curchrsig = mem [curinput .locfield ].hh .v.ME ;
...
zprunemovements ( integer l ) 
{
  ...
  lab30: while ( rightptr != -2147483647L ) {
...
zzreverse ( halfword thisbox , halfword t , scaled * curg , real * curglue ) 
{
  ...
  while ( true ) {
    ...
    while ( p != -2147483647L ) lab21: if ( ( p >= himemmin ) ) 
    do {
	f = mem [p ].hh.b0 ;
      c = mem [p ].hh.b1 ;
...
hlistout ( void ) 
{
  ...
  while ( p != -2147483647L ) lab21: if ( ( p >= himemmin ) ) 
  {
	...
	mem [memtop - 12 ].hh .v.ME = mem [p ].hh .v.ME ;
	p = memtop - 12 ;
	goto lab21 ;
      } 
      break ;
...
znewmarginkern ( scaled w , halfword p , smallnumber side ) 
{
  ...
  pdferror ( 1250 , 1251 ) ;
  {
    ...
    mem [k + 2 ].hh .v.LH = getavail () ;
      ...
      mem [mem [k + 2 ].hh .v.LH ].hh .v.ME = curchrsig ;
	;
#ifdef STAT
      incr ( dynused ) ;
#endif /* STAT */
...
zcleanbox ( halfword p , smallnumber s ) 
{
  ...
  {case 1 : 
    {
      ...
      mem [curmlist ].hh .v.ME = mem [p ].hh .v.ME ;
    } 
    break ;
  case 2 : 
    {
  ...
  lab40: if ( ( q >= himemmin ) || ( q == -2147483647L ) ) 
  x = hpack ( q , 0 , 1 ) ;
...
hchar ) 
{
	...
	if ( currh < 256 ) 
	{
	  ...
	  if ( q .b2 < 128 ) 
	  {
		...
		if ( ligaturepresent ) 
		{
		  ...
		  mem [p ].hh .v.ME = mem [mem [curq ].hh .v.RH ].hh 
		  .v.ME ;
		  if ( lfthit ) 
		  {
		    mem [p ].hh.b1 = 2 ;
  ...
  {
    p = newligature ( hf , curl , mem [curq ].hh .v.RH ) ;
    mem [p ].hh .v.ME = mem [mem [curq ].hh .v.RH ].hh .v.ME ;
    if ( lfthit ) 
    {
      mem [p ].hh.b1 = 2 ;
      lfthit = false ;
...
unpackage ( void ) 
{
  ...
  lab30: while ( mem [curlist .tailfield ].hh .v.RH != -2147483647L ) {
...
maincontrol ( void ) 
{
  ...
  } 
  {
    ...
    ligstack = getavail () ;
      ...
      mem [ligstack ].hh .v.ME = curchrsig ;
	;
#ifdef STAT
      incr ( dynused ) ;
#endif /* STAT */
  ...
  if ( tmpk1 != -2147483647L ) 
  {
	...
	mem [mainp ].hh .v.ME = mem [mem [curq ].hh .v.RH ].hh .v.ME ;
	if ( lfthit ) 
	{
	  mem [mainp ].hh.b1 = 2 ;
	  lfthit = false ;
  ...
  lab112: if ( mainj .b1 == curr ) {
      ...
      case 11 : 
	{
	  if ( curl < 256 ) 
	  {
	    ...
	    {
	      mainp = newligature ( mainf , curl , mem [curq ].hh .v.RH ) ;
	      mem [mainp ].hh .v.ME = mem [mem [curq ].hh .v.RH ].hh 
	      .v.ME ;
	      if ( lfthit ) 
	      {
		mem [mainp ].hh.b1 = 2 ;
...
closefilesandterminate ( void ) 
{
  ...
  if ( fixedpdfoutput > 0 ) 
  {
	...
	if ( fixedpdfdraftmode == 0 ) 
	{
	  ...
	  lab31: if ( ( dests != 0 ) || ( pdfnamestoks != -2147483647L ) ) 
	  {
	    pdfnewdict ( 0 , 0 , 1 ) ;
	    if ( ( dests != 0 ) ) 
